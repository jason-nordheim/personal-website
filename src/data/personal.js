...
export const funFacts = [
  {
    fact:
      "for fun, I stripped my first car's interior material off, insulated the entire cabin, and put it back together, installed a new stereo in the dash, new speakers throughout the car, and wired them all to new amps and subwoofers, and replaced all the lighting with LEDs and HID (for the headlights)",
    category: "automotive",
  },
];
...
export const bucketList = {
  ...
  programming: [
    ...
    {
      goal:
        "Use Node, Express, JWT and bcrypt to build an API that has token based authentication",
      status: "complete",
    },
    {
